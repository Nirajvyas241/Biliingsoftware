...
class Bill_App:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Shri Distributors",bd=12,relief=GROOVE,bg=bg_color,fg="white",font=("times new roman",30,"bold",),pady=2).pack(fill=X)
        #.......variablr water 
        self.one=IntVar()
        self.half=IntVar()
        self.ml=IntVar()
    ...
    def total(self):
        self.a=self.one.get()*95
        self.b=self.half.get()*125
        self.c=self.ml.get()*195
